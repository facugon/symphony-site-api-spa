...
use IAR\CommonsBundle\Entity\Provincia;
use IAR\CommonsBundle\Form\ProvinciaType;
...
class ProvinciaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IARCommonsBundle:Provincia')->findAll();
     ...
     * @Method("POST")
     * @Template("IARCommonsBundle:Provincia:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IARCommonsBundle:Provincia')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IARCommonsBundle:Provincia:edit.html.twig")
     */
