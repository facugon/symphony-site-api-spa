...
use IAR\CommonsBundle\Form\ZonaType;
...
class ZonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IARCommonsBundle:Zona')->findAll();
     ...
     * @Method("POST")
     * @Template("IARCommonsBundle:Zona:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IARCommonsBundle:Zona')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IARCommonsBundle:Zona:edit.html.twig")
     */
