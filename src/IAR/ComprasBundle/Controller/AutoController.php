...
use IAR\ComprasBundle\Entity\Auto;
use IAR\ComprasBundle\Form\AutoType;
...
class AutoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IARComprasBundle:Auto')->findAll();
     ...
     * @Method("POST")
     * @Template("IARComprasBundle:Auto:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IARComprasBundle:Auto')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IARComprasBundle:Auto:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_auto_edit', array('id' => $id)));
        }
