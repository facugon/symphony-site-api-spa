...
use IAR\ComprasBundle\Entity\Compra;
use IAR\ComprasBundle\Form\CompraType;
...
class CompraController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IARComprasBundle:Compra')->findAll();
     ...
     *
     * @Route("/", name="admin_compra_create")
     * @Method("POST")
     * @Template("IARComprasBundle:Compra:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_compra_show', array('id' => $entity->getId())));
        }
    ...
    */
    private function createCreateForm(Compra $entity)
    {
        $form = $this->createForm(new CompraType(), $entity, array(
            'action' => $this->generateUrl('admin_compra_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IARComprasBundle:Compra')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new CompraType(), $entity, array(
            'action' => $this->generateUrl('admin_compra_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="admin_compra_update")
     * @Method("PUT")
     * @Template("IARComprasBundle:Compra:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_compra_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_compra'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_compra_delete', array('id' => $id)))
            ->setMethod('DELETE')
